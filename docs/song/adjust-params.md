...
> - **ALP（声质）**：声音的质感。数值越小越像小孩，数值越大越像大人。
> - **HUS（沙哑度）**：声音的沙哑程度。数值越大声音越沙哑。
...
使用「选择工具」指定范围后，右键点击选择「元音时机校正」。这样会将线条自动调整，使元音位于音符开头。

![元音校正](https://s3.ap-northeast-1.amazonaws.com/wraptas-prod/voisona-manual/348e9bc7-efb1-8027-be33-c8161bc99526/a7521da96f642409bae9b8c7c65645ee.png)
